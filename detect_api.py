...
class simulation_opt:
    def __init__(self,weights,img_size = 640,conf_thres = 0.03,
...
class detectapi:
    def __init__(self,weights,img_size=416,conf_thres = 0.03):
        self.opt = simulation_opt(weights=weights,img_size=img_size,conf_thres = conf_thres)
