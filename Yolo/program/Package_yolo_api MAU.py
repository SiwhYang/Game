...
class Script():
    ...
    def Main(self):
        ...
        print("Initializing...")
        self.detector = detect_api.detectapi(weights="./weights/Hobo_0.05.pt",img_size=416)
    ...
    def string_spliter(self,string):
        ...
        for i in range(0,len(string)):
            result = textwrap.wrap(string[i],spilter)
            for j in range(0,len(result)):
                namelist.append(result[j])
        print(namelist)
        return namelist
...
if __name__ == '__main__':
    ...
    Main_Process = Script("RedDust",["Passer Alpha", "Hobo Cutter"], "Red", 1) # Assassin_Builder_A
